#region Thread Pool
//bir thread havuzu oluşturur ve bu havuzdaki thread'leri kullanarak görevleri çalıştırır. ThreadPool, uygulamanın performansını artırmak ve kaynakları daha verimli kullanmak için tasarlanmıştır. ThreadPool, genellikle kısa süreli ve sık tekrarlanan görevler için uygundur.

// İlk parametre: Worker Thread sayısı (CPU üzerinde çalışan işler)
// İkinci parametre: I/O Completion Port (IOCP) Thread sayısı
// (Dosya okuma/yazma, ağ istekleri, socket işlemleri gibi asenkron I/O işlemlerinin tamamlanmasını işler)

//// Maksimum 4 Worker Thread ve 4 IOCP Thread kullanılabilir
//ThreadPool.SetMaxThreads(4, 4); 

//// Minimum 2 Worker Thread ve 2 IOCP Thread hazır tutulur
//ThreadPool.SetMinThreads(2, 2);

//threadpooldan ilgili iş için thread talep edildi
